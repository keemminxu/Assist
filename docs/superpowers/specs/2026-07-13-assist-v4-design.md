...
- **개정(2026-07-20)**: 아무말 게시판(muse) 정책은 공개 블로그 사적 정보 유출 사고로 전면 폐기.
  §2의 "민수 얘기" 소재 허용, §4.4의 diary_recent(아무말 소재용)·전체 도구 단일 서버,
  §4.5의 "소재: 오늘 대화, diary_recent" 서술은 더 이상 유효하지 않다 —
  현행 정책은 `2026-07-20-muse-isolation-design.md` (뉴스·날씨 견해 전용, 격리 세션)
